package com.ccx.springbootMybatisProject.controller;
...
import com.ccx.springbootMybatisProject.service.UserService;
...
public class UserController {
   ...
   public String register(User user,Model model){
	   ...
	   if(user!=null&&!user.getUserName().trim().isEmpty()&&!user.getPassword().trim().isEmpty()){
		   ...
		   if(user1==null)result= userService.registerUser(user);
	   }
